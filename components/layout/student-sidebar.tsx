...
import { LayoutDashboard, GraduationCap, BookOpen, ClipboardCheck, User, LogOut, Calendar } from "lucide-react"

const navigation = [
  { name: "Mi Portal", href: "/mi-portal", icon: LayoutDashboard },
  { name: "Mis Calificaciones", href: "/mi-portal/notas", icon: GraduationCap },
  { name: "Mis Materias", href: "/mi-portal/materias", icon: BookOpen },
  { name: "Mi Asistencia", href: "/mi-portal/asistencia", icon: ClipboardCheck },
  { name: "Horario", href: "/mi-portal/horario", icon: Calendar },
]
